      ...
      <div className={`grid lg:grid-cols-2 gap-8 items-center`}>
        ...
        <div className={reverse ? 'lg:order-1' : 'lg:order-2'}>
          ...
          <div className="flex items-center gap-5">
            <a href={project.github} className="flex items-center gap-1.5 text-[13px] text-white/50 hover:text-white transition-colors">
            ...
            <a href={project.demo} className="flex items-center gap-1.5 text-[13px] text-white/50 hover:text-white transition-colors">
